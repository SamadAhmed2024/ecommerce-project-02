...
const ProductList = () => {
    ...
    let [Filter,SetFilter]=useState({brandID : "", categoryID : "", PriceMin : "", PriceMax : ""})
            ...
            <div className="row">
                <div className="col-md-3 p-2">
                    <div className="card vh-100 p-3 shadow-sm">
                        <label className="form-label mt-3">Brands1000</label>
                                                    ...
                                                    return(
                                                        <div key={i} className="col-md-3 p-2 col-lg-3 col-sm-6 col-12">
                                                            <Link to={`/details/${item['_id']}`} className="card shadow-sm h-100 rounded-3 bg-white">
                                                                <img alt="" className="w-100 rounded-top-2" src={item['image']} />
